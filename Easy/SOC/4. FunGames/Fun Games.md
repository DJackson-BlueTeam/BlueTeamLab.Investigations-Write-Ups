...
Q2) What is the IP address of the victim?
...
Q3) Which attack was performed by the attacker?
...
Q5) In one of the packets, it is possible to view the victim's username and password.
...
Q6) Once the attacker obtained the victim's credentials he accessed the system via SSH. To gain root privileges, they transferred a file to the victim's machine. What is the name of the file?
...
Q9) After obtaining root privileges, it seems that the attacker exfiltrated sensitive data without transferring any files. Provide the string related to this data.
...
Q10) It seems that the string has been encoded. What data did the attacker manage to obtain through exfiltration?
...
Q11) Provide the Mitre ID of this technique—in regard to the previous question.
